...
- README has en / zh-CN / ja; docs/README.md indexes everything. Product docs
  exist in five languages (en, zh-CN, fr, ja, de); architecture in three
  (en, zh-CN, ja). When touching docs, update every existing language and keep
  code fences paired.
