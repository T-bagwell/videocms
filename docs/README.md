...
![TV Shows](screenshots/series.png)
![Video detail](screenshots/detail.png)
![Player](screenshots/player.png)

## Documentation

All documentation is multi-language. Start at the **[docs index](INDEX.md)**:

| Doc | Languages | Audience |
| --- | --- | --- |
| [Product documentation](product.md) | EN · 中文 · FR · JA · DE | End users |
| [System architecture](architecture.md) | EN · 中文 · JA | Developers |
| [README](README.md) / [中文](README.zh-CN.md) / [日本語](README.ja.md) | EN · 中文 · 日本語 | Everyone |
